package es.juanlsanchez.chefs.config;

import es.juanlsanchez.chefs.security.*;
import es.juanlsanchez.chefs.web.filter.CsrfCookieGeneratorFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers( HttpMethod.GET, "/api/search/tags/{.+}").permitAll()
            ...
            .antMatchers( HttpMethod.GET, "/api/likes/{\\d+}").permitAll()

...
public class EventResourceTest {
    ...
    public void createEvent() throws Exception {
        ...
        assertThat(testEvent.getDate().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_DATE);
    }
    ...
    public void updateEvent() throws Exception {
        ...
        assertThat(testEvent.getDate().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_DATE);
    }
